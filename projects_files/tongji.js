...
{
	var unit_id     = "2968491";
	var client_ip   = "61.183.52.208";
	var server_time = "1369016461";
	var verify_code = "14304095";
	var type        = "0";
...
document.write("<img src=\""+dest+"\" border=\"0\" width=\"1\" height=\"1\" />");
	...
	var icon_link_host="tongji.linezing.com";
        ...
        if(url_id>0)
                document.write('<scr'+'ipt src=\'http://js.tongji.linezing.com/2968491/'+url_id+'/clickcollect.js\'></scr'+'ipt>');
}
